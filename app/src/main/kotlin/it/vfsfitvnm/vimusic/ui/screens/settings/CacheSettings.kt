...
fun CacheSettings() {
    ...
    Column(
        ...
        SettingsDescription(text = "Cuando la caché se queda sin espacio, se borran los recursos a los que no se ha accedido durante más tiempo.")
        ...
        binder?.cache?.let { cache ->
            ...
            SettingsEntryGroupText(title = "CACHÉ DE CANCIONES")
