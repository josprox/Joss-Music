...
fun OtherSettings() {
    ...
    Column(
        ...
        SettingsDescription(text = "Recuerde habilitar \"Fuentes desconocidas\" en la configuración para desarrolladores de Android Auto.")
        ...
        SettingsEntryGroupText(title = "Historial de búsqueda")

        SwitchSettingEntry(
            title = "Pausar el historial de búsqueda",
            text = "No guardar nuevas consultas buscadas ni mostrar el historial",
        ...
        SettingsEntry(
            ...
            text = if (queriesCount > 0) {
                "Eliminar $queriesCount consultas de búsqueda"
            } else {
        ...
        SettingsEntryGroupText(title = "Vida util")

        ImportantSettingsDescription(text = "Si se aplican optimizaciones de batería, la notificación de reproducción puede desaparecer repentinamente cuando se pausa.")

        if (isAtLeastAndroid12) {
            SettingsDescription(text = "Desde Android 12, es necesario deshabilitar las optimizaciones de la batería para que la opción \"Servicio invencible\" surta efecto.")
        }

        SettingsEntry(
            title = "Ignorar las optimizaciones de la batería",
            ...
            onClick = {
                ...
                try {
                    ...
                    try {
                        ...
                        context.toast("No se pudieron encontrar las configuraciones de optimización de la batería, incluya Joss Music en la lista blanca manualmente")
                    }
                }
            }
        )
        ...
        SwitchSettingEntry(
            ...
            text = "Cuando desactivar las optimizaciones de batería no es suficiente",
